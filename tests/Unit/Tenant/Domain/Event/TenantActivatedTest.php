...
final class TenantActivatedTest extends TestCase
{
    public function testConstructorSetsTenantId(): void
    {
        ...
        // Act
        $event = new TenantActivated($tenantId);
    ...
    public function testMultipleEventsWithDifferentIds(): void
    {
        ...
        // Act
        $event1 = new TenantActivated($tenantId1);
        $event2 = new TenantActivated($tenantId2);

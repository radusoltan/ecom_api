...
use App\Order\Infrastructure\ApiPlatform\State\StartPackingProcessor;
...
#[CoversClass(StartPackingProcessor::class)]
final class StartPackingProcessorTest extends TestCase
{
    private MessageBusInterface&MockObject $commandBus;
    private StartPackingProcessor $processor;

    protected function setUp(): void
    {
        $this->commandBus = $this->createMock(MessageBusInterface::class);
        $this->processor = new StartPackingProcessor($this->commandBus);
    }

...
use App\Order\Infrastructure\ApiPlatform\State\DeliverFulfillmentProcessor;
...
#[CoversClass(DeliverFulfillmentProcessor::class)]
final class DeliverFulfillmentProcessorTest extends TestCase
{
    private MessageBusInterface&MockObject $commandBus;
    private DeliverFulfillmentProcessor $processor;

    protected function setUp(): void
    {
        $this->commandBus = $this->createMock(MessageBusInterface::class);
        $this->processor = new DeliverFulfillmentProcessor($this->commandBus);
    }

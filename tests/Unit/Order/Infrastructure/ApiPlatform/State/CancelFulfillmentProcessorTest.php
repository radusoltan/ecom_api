...
use App\Order\Infrastructure\ApiPlatform\State\CancelFulfillmentProcessor;
...
#[CoversClass(CancelFulfillmentProcessor::class)]
final class CancelFulfillmentProcessorTest extends TestCase
{
    private MessageBusInterface&MockObject $commandBus;
    private CancelFulfillmentProcessor $processor;

    protected function setUp(): void
    {
        $this->commandBus = $this->createMock(MessageBusInterface::class);
        $this->processor = new CancelFulfillmentProcessor($this->commandBus);
    }

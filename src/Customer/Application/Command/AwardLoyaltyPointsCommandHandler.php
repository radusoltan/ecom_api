...
#[AsMessageHandler]
final readonly class AwardLoyaltyPointsCommandHandler
{
    ...
    public function __invoke(AwardLoyaltyPointsCommand $command): void
    {
        ...
        $customer->awardLoyaltyPoints($command->points, $command->reason);

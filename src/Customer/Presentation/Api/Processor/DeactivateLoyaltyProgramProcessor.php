...
/**
 * Deactivate Loyalty Program Processor.
 *
 * Processes the deactivation of a loyalty program.
 *
 * @implements ProcessorInterface<LoyaltyProgramResource, LoyaltyProgramResource>
 */
final readonly class DeactivateLoyaltyProgramProcessor implements ProcessorInterface
{
    ...
    public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = []): LoyaltyProgramResource
    {
        ...
        // Retrieve the deactivated program
        ...
        if (null === $programDTO) {
            throw new \RuntimeException('Loyalty program not found after deactivation');
        }

...
/**
 * Processor for completing a return (issuing refund).
 */
final class CompleteReturnRequestProcessor implements ProcessorInterface
{
    use HandleTrait;
    ...
    public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = []): ReturnRequestResource
    {
        ...
        $command = new CompleteReturnRequest(

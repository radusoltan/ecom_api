...
/**
 * Processor for inspecting a returned item.
 */
final class InspectReturnRequestProcessor implements ProcessorInterface
{
    use HandleTrait;
    ...
    public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = []): ReturnRequestResource
    {
        ...
        $command = new InspectReturnRequest(
            returnRequestId: $returnRequestId,
            isResellable: $data->isResellable,

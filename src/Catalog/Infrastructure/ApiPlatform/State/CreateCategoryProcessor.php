...
/**
 * Custom processor for creating categories.
...
final readonly class CreateCategoryProcessor implements ProcessorInterface
{
    ...
    public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = []): CategoryEntity
    {
        ...
        $idProperty->setValue($data, $categoryId);

 ...
 */
final readonly class SuspendTenantProcessor implements ProcessorInterface
{
    ...
    public function process(
        ...
        // Dispatch command to suspend tenant
        $command = new SuspendTenantCommand(tenantId: $tenantId);
        ...
        if (null === $tenantDTO) {
            throw new RuntimeException('Tenant not found after suspension');
        }

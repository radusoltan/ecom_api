...
final class Version20251102110008 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE data_subject_requests (id VARCHAR(26) NOT NULL, tenant_id VARCHAR(36) NOT NULL, customer_id VARCHAR(36) NOT NULL, request_type VARCHAR(50) NOT NULL, status VARCHAR(50) NOT NULL, reason TEXT DEFAULT NULL, review_notes TEXT DEFAULT NULL, rejection_reason TEXT DEFAULT NULL, export_data JSON DEFAULT NULL, submitted_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, completed_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, deadline TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, is_extended BOOLEAN NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');

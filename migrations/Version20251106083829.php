...
final class Version20251106083829 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product_reviews (id VARCHAR(36) NOT NULL, product_id VARCHAR(36) NOT NULL, customer_id VARCHAR(36) DEFAULT NULL, tenant_id VARCHAR(36) NOT NULL, rating SMALLINT NOT NULL, title VARCHAR(255) DEFAULT NULL, content TEXT DEFAULT NULL, is_verified_purchase BOOLEAN DEFAULT false, status VARCHAR(20) DEFAULT \'pending\', created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL, customer_name VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE audit_log (id VARCHAR(36) NOT NULL, tenant_id VARCHAR(36) NOT NULL, user_id VARCHAR(36) DEFAULT NULL, action_type VARCHAR(50) NOT NULL, resource_type VARCHAR(50) NOT NULL, resource_id VARCHAR(255) NOT NULL, metadata JSONB DEFAULT \'{}\' NOT NULL, ip_address VARCHAR(45) DEFAULT NULL, user_agent TEXT DEFAULT NULL, occurred_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
